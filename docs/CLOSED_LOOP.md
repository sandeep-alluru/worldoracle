# Closed loop — `worldoracle`

**Status:** stub (eagle-eyes Phase 0 / 2026-08-04)  
**Owner loop:** Gate (proven in Foundry when wired)

## Load-bearing job

Belief contradiction detect + repair

## Who reads the output?

G-CONTRA-style gate or multi-source merge step

## What outcome changes?

Resolved belief or human-stop on legal/contradiction gates

## When NOT to use (anti-ornament)

Do not skip human-only legal gates with auto-repair
